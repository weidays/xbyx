...
import com.web.back.dao.JypxDAO;
import com.web.back.model.Jypx;
@Repository
public class JypxDAOImpl  implements JypxDAO
{
    ...
    public boolean saveMedia(Jypx media) throws Exception
    {
    ...
    public List<Jypx> queryALlMedia(int firstResult, int maxResult) throws Exception
    {
        // TODO Auto-generated method stub
        return null;
    }

    public Jypx queryMediaById(int id) throws Exception
    {
        // TODO Auto-generated method stub
        return null;
    }
