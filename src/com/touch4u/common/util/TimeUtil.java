 ...
 * </p>
 * <p>
 * Copyright: Copyright (c) 2011-07-18
 * </p>
 * 
 * @author huangxun
 * @version 1.0
...
public class TimeUtil
{
     ...
     * 获取当前时间指定偏移类的时间对象
     * 
     * @param field 偏移的域， 以Calendar常量取值， 如 Calendar.DATE
     * @param offset 正负数偏移量
     * @return
     */
     ...
     * @param field 指定域， 以Calendar常量取值
     * @param offset 正负数偏移量，不偏移取0
     * @return
     */
    ...
    /**
     * function:根据时间字符串获取秒数
     * 
     *@param dateStr
     *@return
     *@author huangxy
     */
    public static Long getTimeInSeconds(String dateStr)
    {
        Calendar calendar = Calendar.getInstance();
    ...
    /**
     * function:根据时间秒数转换为指定时间格式字符串
     * 
     *@param dateStr
     *@return
     *@author huangxy
     */
    public static String paraseDateFromSeconds(String seconds, String pattern)
    {
        Calendar calendar = Calendar.getInstance();
    ...
    {
        System.out.println(TimeUtil.getAppendixFilename());
    }
